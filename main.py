...
asteroid50 = pygame.image.load('asteroidimage (3).png')
asteroid100 = pygame.image.load('asteroidimage (2).png')
asteroid150 = pygame.image.load('asteroidimage (1).png')

shoot = pygame.mixer.Sound('shoot.wav')
bangLargeSound = pygame.mixer.Sound('bangLarge.wav')
bangSmallSound = pygame.mixer.Sound('bangSmall.wav')
shoot.set_volume(1)
bangLargeSound.set_volume(1)
bangSmallSound.set_volume(1)
...
class Player(object):
    ...
    def __init__(self):
        #self is used to access the current object
        ...
        #To enclose the rotation in a rectangle, for rotation on the same position and no translation
        self.rotatedRect.center = (self.x, self.y)
        #set the centre coordinates of the enclosed rectangle
        self.cosine = math.cos(math.radians(self.angle + 90))
        self.sine = math.sin(math.radians(self.angle + 90))
        self.head = (self.x + self.cosine * self.w//2, self.y - self.sine * self.h//2)
        #To position the head of firing, to be at the exact centre

    def draw(self, win):
        #win.blit(self.img, [self.x, self.y, self.w, self.h])

        win.blit(self.rotatedSurf, self.rotatedRect)
        #By calling win.blit(self.rotatedSurf, self.rotatedRect), you are effectively blitting (copying) the contents of self.rotatedSurf onto the win surface, using the position and dimensions specified by self.rotatedRect
